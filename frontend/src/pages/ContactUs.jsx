              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">hello@eventix.com</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">+91 555 444 3333</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">456 Patna Street</p>
                    <p className="text-slate-600">Patna, Bihar 800001, India</p>
                  </div>
                </div>
              </div>
            </div>
